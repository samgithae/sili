...
$nextPayOutDay= isset(SettingController::getId(1)['payoutDay'])? SettingController::getId(1)['payoutDay']: 'not set';
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item"> <b>Next Payout:</b> <?php echo $nextPayOutDay?></li>
