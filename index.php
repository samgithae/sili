...
<section class="title_sectionk desktop-hide" id="mobile_login" style="margin-bottom:170px;">

  <div class="container">
<div class="row tagLogin ">
<h3>Asili Africa E-learning Centre</h3>
            <div class="col-md-12">
...
<section class="title_sectionk" id="title_about">
  <div class="container">
      ...
      <div class="col-sm-12 desktop-hide-introm">
         ...
         <h3 style="font-family: 'Jura', sans-serif;"> We are an independent private organization that has been set up to
    ...
    <div class="col-sm-8">
        <div>
            ...
            <h4 style="font-family: 'Jura', sans-serif;"> We compile innovative e-learning programs, services and experiences, designed to bring your professional and personal life in alignment with your educational needs at your pace.</br></br></h4>
        </div>

        <div>
            <h4 style="text-align: center; font-family: 'Jura', sans-serif;"><i class="rt-icon-graduate"></i> </h4>
            <h4 style="font-family: 'Jura', sans-serif;">We offer guidance on career choices across all levels educational needs within communities with individuals and families, organizations and industries.<br><br></h4>

        </div>


      <div>
          <h4 style="text-align: center; font-family: 'Jura', sans-serif;"><i class="rt-icon-support"></i> </h4>
          <h4 style="font-family: 'Jura', sans-serif;">We assist, individuals and organizations acquire the right skills set to be on the knowledgeable edge with the fast evolving Internet opportunities in the global society.<br> <br> </h4>
      </div>
       </div>
  </div></div>
</section>
      ...
      <div class="block col-sm-12 col-sm-offset-3">
        ...
        <div class="left_icons to_slide_left">
          ...
          <div class="single_teaser_right">
            ...
            <h3>We offer consultancy services for the E-learning services.</h3>
        </div>
      </div>
            ...
            <div class="row">
                ...
                <div class="block widget_nav_menu col-sm-3">
                    ...
                    <ul class="nav menu">
                       ...
                       <!-- <li><a href="views/signup.php">Join Us</a></li>--!>
